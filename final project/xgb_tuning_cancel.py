...
grid_xgb = GridSearchCV(estimator = XGBClassifier( 
                                                  learning_rate = 0.01, n_estimators=250, max_depth=40,
                                                  min_child_weight=0.01, gamma=0.025, subsample=1, colsample_bytree=0.575,
                                                  objective= 'binary:logistic', reg_lambda = 1e-5, reg_alpha = 1e-5,
                                                  nthread=4, scale_pos_weight=1, seed=27), 
                                                  param_grid = param_test1, n_jobs=96, iid=False, scoring='roc_auc', verbose=2,
